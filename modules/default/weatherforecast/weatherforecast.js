...
Module.register("weatherforecast",{
	...
	defaults: {
		...
		nextDayInterval: 5 * 1000, // every 5 sec
		animationSpeed: 1000,
	...
	getDom: function() {
		...
		//for (var f in this.forecast) {
			if (this.numDateShowed < this.forecast.length - 1) {
				this.numDateShowed +=  1;
			} else {
				this.numDateShowed = 0;
			}
			var forecast = this.forecast[this.numDateShowed];
		...
		//}
		//updatedayinterval = setInterval(this.updateDay, this.config.nextDayInterval);
